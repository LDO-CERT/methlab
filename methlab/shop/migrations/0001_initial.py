    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shop_mailtags', to='shop.flag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='mail',
            name='tags',
            field=taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='shop.MailTag', to='shop.Flag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='IocTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.ioc')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shop_ioctags', to='shop.flag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='ioc',
            name='tags',
            field=taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='shop.IocTag', to='shop.Flag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='AttachmentTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.attachment')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shop_attachmenttags', to='shop.flag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='tags',
            field=taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='shop.AttachmentTag', to='shop.Flag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='AddressTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.address')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shop_addresstags', to='shop.flag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='address',
            name='tags',
            field=taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='shop.AddressTag', to='shop.Flag', verbose_name='Tags'),
        ),
        migrations.AddIndex(
            model_name='mail',
