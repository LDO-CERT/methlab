# Generated by Django 3.1.7 on 2021-03-01 14:44
    ...
    def generate_superuser(app, schema_editor):
        ...
        if superusers == 0:
            superuser = get_user_model().objects.create_superuser(
                username="admin", email="admin@methlab.local", password="s3cr3t"
            )
            superuser.save()
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "color",
                    colorfield.fields.ColorField(default="#30357B", max_length=18),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "progress",
                    models.PositiveIntegerField(
                        choices=[(0, "new"), (1, "processing"), (2, "done")], default=0
                    ),
                ),
                (
                    "suggested_response",
                ...
                (
                    "slug_subject",
                    models.SlugField(default="", editable=False, max_length=1000),
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("value", "type"), name="duplicated_wl"
            ),
        ),
        migrations.AddField(
            model_name="url",
        ...
        migrations.AddField(
            ...
            name="mail",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="shop.mail"
            ),
        ),
        migrations.AddField(
            model_name="mail",
        ...
        migrations.AddField(
            ...
            name="attachments",
            field=models.ManyToManyField(
                related_name="attachments", to="shop.Attachment"
            ),
        ),
        migrations.AddField(
            model_name="mail",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="shop_customtag_tagged_items",
                to="contenttypes.contenttype",
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["search_vector"], name="shop_mail_search__5e794b_gin"
            ),
        ),
